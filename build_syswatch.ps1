...
class Config:
    ...
    SSH_PRIVATE_KEY_PATH = os.getenv("SSH_PRIVATE_KEY_PATH", "C:/SysWatch/keys/syswatch_key")
...
# Dashboard HTML (full version)
Write-File "modules/web_ui/templates/dashboard.html" @'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
Write-File "modules/web_ui/templates/login.html" @'
<!DOCTYPE html>
...
Write-File "modules/alert_engine/notifiers.py" @'
...
# ----------------------------------------------------------------------
Write-File "modules/remote_exec/__init__.py" ""
Write-File "modules/remote_exec/executor.py" @'
...
Write-File "modules/discovery/__init__.py" ""
Write-File "modules/discovery/sweep.py" @'
...
Write-File "modules/remediation/__init__.py" ""
Write-File "modules/remediation/suggest.py" @'
...
# 11. SCRIPTS
# ----------------------------------------------------------------------
Write-File "scripts/deploy_agent.sh" @'
#!/bin/bash
# deploy_agent.sh stub for Windows build
echo "Use Windows deployment via WinRM."
'@
...
SSH_USER=syswatch
SSH_PRIVATE_KEY_PATH=C:/SysWatch/keys/syswatch_key
SSH_TIMEOUT=10
WINRM_USER=syswatch
